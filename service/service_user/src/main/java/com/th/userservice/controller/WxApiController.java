...
import com.th.userservice.ustils.Constants;
import com.th.userservice.ustils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String getWxCode() {
        ...
        String redirectUrl = Constants.WX_OPEN_REDIRECT_URL;
        try {
    ...
    public String callback(String code, String state) {
        try {
            ...
            return "redirect:http://localhost:8000/welcome?token=" + jwtToken;
        } catch (Exception e) {
